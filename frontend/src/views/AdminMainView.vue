<template>
    <div class = "screen">
        ...
        <div style="width: 389px; height: 660px; background-color: white; position: relative;">
            <button class="admin_main_button" style = "top: 180px;" @click="moveToAsk"> 리소스 권한 설정 및 요청 목록 </button>
            <button class="admin_main_button" style = "top: 300px;" @click="moveToDB"> 사용자 DB 제어판 </button>
        </div>
    </div>
</template>
