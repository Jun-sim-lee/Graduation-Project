<template>
    <component v-bind:is="script" type="text/javascript" src="src/mqtt/mqttws31.js"/>
    <component v-bind:is="script" type="text/javascript" src="src/mqtt/mqttws31-min.js"/>
...
const computedX = computed(() => 1320 - (coordDto.value.x) * 70);
const computedY = computed(() => 930 - (coordDto.value.y) * 60);
